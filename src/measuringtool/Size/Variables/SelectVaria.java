 ...
 * @author asus
 */
public class SelectVaria extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectVaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
