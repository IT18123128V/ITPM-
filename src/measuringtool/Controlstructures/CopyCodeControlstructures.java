 ...
 * @author asus
 */
public class CopyCodeControlstructures extends javax.swing.JFrame {

    /**
     * Creates new form CopyCodeControlstructures
     */
    public CopyCodeControlstructures() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Control Structures ");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "LineNo", "Program", "Wtc", "NC", "Ccspps", "Ccs"
            }
        ) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        for (String line : jTextArea1.getText().split("\\n"))
        {
                ...
                
            {
                linebyline +=1;
                CC.codeOnly(line);
                Object JFill[] = {linebyline,line,CC.getCs(),CC.getCtc(),CC.getCnc(),CC.getCi(),CC.getTW(),CC.getCps(),CC.getCr(),CC.getCs(),CC.getCr()};
                model.addRow(JFill);
                CC.resetAllGrades(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CopyCodeControlstructures.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
