 ...
 * @author asus
 */
public class SelectControlstructures extends javax.swing.JFrame {

    
    private final JFileChooser openFileChooserCPluse;
    private final JFileChooser openFileChooser;
    /**
     * Creates new form SelectControlstructures
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectControlstructures.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelectControlstructures().setVisible(true);
            }
        });
    }
